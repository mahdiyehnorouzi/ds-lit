import { unsafeCSS as pt, css as ut, LitElement as B, html as $ } from "lit";
const q = (r) => (t, e) => {
...
const gt = (r) => new ft(typeof r == "string" ? r : r + "", void 0, at), bt = (r, t) => {
...
const { is: mt, defineProperty: vt, getOwnPropertyDescriptor: wt, getOwnPropertyNames: yt, getOwnPropertySymbols: $t, getPrototypeOf: xt } = Object, R = globalThis, X = R.trustedTypes, _t = X ? X.emptyScript : "", At = R.reactiveElementPolyfillSupport, z = (r, t) => r, T = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? _t : null;
      break;
  ...
  return e;
} }, K = (r, t) => !mt(r, t), Y = { attribute: !0, type: String, converter: T, reflect: !1, useDefault: !1, hasChanged: K };
...
let E = class extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of i) e.unshift(Q(o));
  ...
  _$ET(t, e) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const s = (i.converter?.toAttribute !== void 0 ? i.converter : T).toAttribute(e, i.type);
  ...
  _$AK(t, e) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const s = i.getPropertyOptions(o), n = typeof s.converter == "function" ? { fromAttribute: s.converter } : s.converter?.fromAttribute !== void 0 ? s.converter : T;
      this._$Em = o;
...
E.elementStyles = [], E.shadowRootOptions = { mode: "open" }, E[z("elementProperties")] = /* @__PURE__ */ new Map(), E[z("finalized")] = /* @__PURE__ */ new Map(), At?.({ ReactiveElement: E }), (R.reactiveElementVersions ??= []).push("2.1.2");
const kt = { attribute: !0, type: String, converter: T, reflect: !1, hasChanged: K }, Et = (r = kt, t, e) => {
...
const Ot = (r, t) => {
  ...
  let o, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", n = S;
  for (let l = 0; l < e; l++) {
    const a = r[l];
    let h, p, c = -1, g = 0;
    for (; g < a.length && (n.lastIndex = g, p = n.exec(a), p !== null); ) g = n.lastIndex, n === S ? p[1] === "!--" ? n = it : p[1] !== void 0 ? n = ot : p[2] !== void 0 ? (ht.test(p[2]) && (o = RegExp("</" + p[2], "g")), n = w) : p[3] !== void 0 && (n = w) : n === w ? p[0] === ">" ? (n = o ?? S, c = -1) : p[1] === void 0 ? c = -2 : (c = n.lastIndex - p[2].length, h = p[1], n = p[3] === void 0 ? w : p[3] === '"' ? st : rt) : n === st || n === rt ? n = w : n === it || n === ot ? n = S : (n = w, o = void 0);
    const b = n === w && r[l + 1].startsWith("/>") ? " " : "";
    s += n === S ? a + Ct : c >= 0 ? (i.push(h), a.slice(0, c) + lt + a.slice(c) + m + b) : a + m + (c === -2 ? l : b);
  }
  return [dt(r, s + (r[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class P {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    if (this.el = P.createElement(h, i), y.currentNode = this.el.content, e === 2 || e === 3) {
      const c = this.el.content.firstChild;
      c.replaceWith(...c.childNodes);
    }
    for (; (o = y.nextNode()) !== null && a.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const c of o.getAttributeNames()) if (c.endsWith(lt)) {
          const g = p[n++], b = o.getAttribute(c).split(m), M = /([.?@])?(.*)/.exec(g);
          a.push({ type: 1, index: s, name: M[2], strings: b, ctor: M[1] === "." ? Mt : M[1] === "?" ? jt : M[1] === "@" ? Tt : L }), o.removeAttribute(c);
        ...
        if (ht.test(o.tagName)) {
          ...
          if (g > 0) {
            ...
            for (let b = 0; b < g; b++) o.append(c[b], H()), y.nextNode(), a.push({ type: 2, index: ++s });
            o.append(c[g], H());
          }
        }
      } else if (o.nodeType === 8) if (o.data === ct) a.push({ type: 2, index: s });
      else {
        let c = -1;
...
class Ut {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let h;
        a.type === 2 ? h = new D(s, s.nextSibling, this, t) : a.type === 1 ? h = new a.ctor(s, a.name, a.strings, this, t) : a.type === 6 && (h = new Nt(s, this, t)), this._$AV.push(h), a = i[++l];
      }
...
class D {
  ...
  _$AI(t, e = this) {
    t = k(this, t, e), C(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== A && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Pt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: e, _$litType$: i } = t, o = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = P.createElement(dt(i.h, i.h[0]), this.options)), i);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let i, o = 0;
    for (const s of t) o === e.length ? e.push(i = new D(this.O(H()), this.O(H()), this, this.options)) : i = e[o], i._$AI(s), o++;
...
class L {
  ...
  _$AI(t, e = this, i, o) {
    ...
    let n = !1;
    if (s === void 0) t = k(this, t, e, 0), n = !C(t) || t !== this._$AH && t !== A, n && (this._$AH = t);
    else {
      const l = t;
      let a, h;
      for (t = s[0], a = 0; a < s.length - 1; a++) h = k(this, l[i + a], e, a), h === A && (h = this._$AH[a]), n ||= !C(h) || h !== this._$AH[a], h === d ? t = d : t !== d && (t += (h ?? "") + s[a + 1]), this._$AH[a] = h;
    }
    n && !o && this.j(t);
  }
  j(t) {
...
Ht?.(P, D), (F.litHtmlVersions ??= []).push("3.3.2");
...
var Bt = Object.defineProperty, qt = Object.getOwnPropertyDescriptor, U = (r, t, e, i) => {
  for (var o = i > 1 ? void 0 : i ? qt(t, e) : t, s = r.length - 1, n; s >= 0; s--)
  ...
  render() {
    ...
    return $`
      <button class=${e} ?disabled=${this.disabled || this.loading}>
        ${this.loading ? $`<span class="mr-2 inline-block h-4 w-4 animate-spin rounded-full border-2 border-white/40 border-t-white"></span>` : null}
        <slot></slot>
      </button>
    `;
  }
...
var Wt = Object.defineProperty, Kt = Object.getOwnPropertyDescriptor, v = (r, t, e, i) => {
  for (var o = i > 1 ? void 0 : i ? Kt(t, e) : t, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = (i ? n(t, e, o) : n(o)) || o);
...
var Vt = Object.defineProperty, Ft = Object.getOwnPropertyDescriptor, J = (r, t, e, i) => {
