import { unsafeCSS as q, css as K, LitElement as V, html as $ } from "lit";
const F = (r) => (t, e) => {
  e !== void 0 ? e.addInitializer(() => {
    customElements.define(r, t);
  }) : customElements.define(r, t);
};
const T = globalThis, Z = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ct = /* @__PURE__ */ Symbol(), Q = /* @__PURE__ */ new WeakMap();
let gt = class {
  constructor(t, e, i) {
...
const { is: vt, defineProperty: yt, getOwnPropertyDescriptor: $t, getOwnPropertyNames: wt, getOwnPropertySymbols: _t, getPrototypeOf: xt } = Object, R = globalThis, tt = R.trustedTypes, At = tt ? tt.emptyScript : "", Et = R.reactiveElementPolyfillSupport, P = (r, t) => r, j = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? At : null;
      break;
  ...
  return e;
} }, J = (r, t) => !vt(r, t), et = { attribute: !0, type: String, converter: j, reflect: !1, useDefault: !1, hasChanged: J };
...
let k = class extends HTMLElement {
  ...
  requestUpdate(t, e, i, s = !1, o) {
    if (t !== void 0) {
      ...
      if (s === !1 && (o = this[t]), i ??= n.getPropertyOptions(t), !((i.hasChanged ?? J)(o, e) || i.useDefault && i.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(n._$Eu(t, i)))) return;
      this.C(t, e, i);
    }
...
k.elementStyles = [], k.shadowRootOptions = { mode: "open" }, k[P("elementProperties")] = /* @__PURE__ */ new Map(), k[P("finalized")] = /* @__PURE__ */ new Map(), Et?.({ ReactiveElement: k }), (R.reactiveElementVersions ??= []).push("2.1.2");
const St = { attribute: !0, type: String, converter: j, reflect: !1, hasChanged: J }, kt = (r = St, t, e) => {
...
const Ct = (r, t, e) => (e.configurable = !0, e.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(r, t, e), e);
function Pt(r, t) {
  return (e, i, s) => {
...
const X = globalThis, it = (r) => r, N = X.trustedTypes, st = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ht = "$lit$", m = `lit$${Math.random().toFixed(9).slice(2)}$`, dt = "?" + m, zt = `<${dt}>`, w = document, H = () => w.createComment(""), z = (r) => r === null || typeof r != "object" && typeof r != "function", G = Array.isArray, Ot = (r) => G(r) || typeof r?.[Symbol.iterator] == "function", I = `[ 	
\f\r]`, C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, rt = /-->/g, ot = />/g, v = RegExp(`>|${I}(?:([^\\s"'>=/]+)(${I}*=${I}*(?:[^ 	
...
const Mt = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const a = r[l];
    let h, p, c = -1, f = 0;
    for (; f < a.length && (n.lastIndex = f, p = n.exec(a), p !== null); ) f = n.lastIndex, n === C ? p[1] === "!--" ? n = rt : p[1] !== void 0 ? n = ot : p[2] !== void 0 ? (pt.test(p[2]) && (s = RegExp("</" + p[2], "g")), n = v) : p[3] !== void 0 && (n = v) : n === v ? p[0] === ">" ? (n = s ?? C, c = -1) : p[1] === void 0 ? c = -2 : (c = n.lastIndex - p[2].length, h = p[1], n = p[3] === void 0 ? v : p[3] === '"' ? at : nt) : n === at || n === nt ? n = v : n === rt || n === ot ? n = C : (n = v, s = void 0);
    const b = n === v && r[l + 1].startsWith("/>") ? " " : "";
    o += n === C ? a + zt : c >= 0 ? (i.push(h), a.slice(0, c) + ht + a.slice(c) + m + b) : a + m + (c === -2 ? l : b);
  }
    ...
    for (; (s = y.nextNode()) !== null && a.length < l; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const c of s.getAttributeNames()) if (c.endsWith(ht)) {
          const f = p[n++], b = s.getAttribute(c).split(m), U = /([.?@])?(.*)/.exec(f);
          a.push({ type: 1, index: o, name: U[2], strings: b, ctor: U[1] === "." ? Tt : U[1] === "?" ? jt : U[1] === "@" ? Nt : D }), s.removeAttribute(c);
...
class Ut {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let h;
        a.type === 2 ? h = new L(o, o.nextSibling, this, t) : a.type === 1 ? h = new a.ctor(o, a.name, a.strings, this, t) : a.type === 6 && (h = new Ht(o, this, t)), this._$AV.push(h), a = i[++l];
      }
...
class L {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), z(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== A && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ot(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== d && z(this._$AH) ? this._$AA.nextSibling.data = t : this.T(w.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: e, _$litType$: i } = t, s = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = O.createElement(ut(i.h, i.h[0]), this.options)), i);
...
class D {
  ...
  _$AI(t, e = this, i, s) {
    ...
    if (o === void 0) t = E(this, t, e, 0), n = !z(t) || t !== this._$AH && t !== A, n && (this._$AH = t);
      ...
      const l = t;
      let a, h;
      for (t = o[0], a = 0; a < o.length - 1; a++) h = E(this, l[i + a], e, a), h === A && (h = this._$AH[a]), n ||= !z(h) || h !== this._$AH[a], h === d ? t = d : t !== d && (t += (h ?? "") + o[a + 1]), this._$AH[a] = h;
    }
    n && !s && this.j(t);
  }
  j(t) {
...
Rt?.(O, L), (X.litHtmlVersions ??= []).push("3.3.2");
const Lt = { ATTRIBUTE: 1 }, Dt = (r) => (...t) => ({ _$litDirective$: r, values: t });
class Bt {
  constructor(t) {
  }
  get _$AU() {
...
var Gt = Object.defineProperty, Qt = Object.getOwnPropertyDescriptor, B = (r, t, e, i) => {
  for (var s = i > 1 ? void 0 : i ? Qt(t, e) : t, o = r.length - 1, n; o >= 0; o--)
    (n = r[o]) && (s = (i ? n(t, e, s) : n(s)) || s);
...
let S = class extends V {
  constructor() {
    super(...arguments), this.open = !1, this.title = "", this.handleWindowKeyDown = (r) => {
      this.open && Xt(() => this.close("escape"))(r);
  ...
  close(r) {
    this.open && (this.open = !1, Wt(this, "lit-modal:close", { reason: r }));
  }
  updated(r) {
