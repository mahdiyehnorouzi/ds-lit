import { unsafeCSS as ut, css as ft, LitElement as W, html as y } from "lit";
const q = (r) => (t, e) => {
...
const Z = globalThis, et = (r) => r, N = Z.trustedTypes, it = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ct = "$lit$", m = `lit$${Math.random().toFixed(9).slice(2)}$`, ht = "?" + m, Pt = `<${ht}>`, $ = document, H = () => $.createComment(""), P = (r) => r === null || typeof r != "object" && typeof r != "function", F = Array.isArray, Ot = (r) => F(r) || typeof r?.[Symbol.iterator] == "function", D = `[ 	
\f\r]`, z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ot = /-->/g, rt = />/g, v = RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
...
const Ut = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    ...
    s += n === z ? a + Pt : c >= 0 ? (i.push(h), a.slice(0, c) + ct + a.slice(c) + m + b) : a + m + (c === -2 ? l : b);
  }
    ...
    for (; (o = w.nextNode()) !== null && a.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const c of o.getAttributeNames()) if (c.endsWith(ct)) {
          ...
          a.push({ type: 1, index: s, name: M[2], strings: b, ctor: M[1] === "." ? Tt : M[1] === "?" ? jt : M[1] === "@" ? Nt : I }), o.removeAttribute(c);
...
var Jt = Object.defineProperty, Gt = Object.getOwnPropertyDescriptor, x = (r, t, e, i) => {
  for (var o = i > 1 ? void 0 : i ? Gt(t, e) : t, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = (i ? n(t, e, o) : n(o)) || o);
...
var te = Object.defineProperty, ee = Object.getOwnPropertyDescriptor, B = (r, t, e, i) => {
  for (var o = i > 1 ? void 0 : i ? ee(t, e) : t, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (o = (i ? n(t, e, o) : n(o)) || o);
